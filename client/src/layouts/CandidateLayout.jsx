        ...
        `} style={{ backgroundColor: 'var(--sidebar)', borderColor: 'var(--border)' }}>
          <div className="flex flex-col h-full">
            ...
            <div className="hidden lg:block px-6 py-4 border-b" style={{ borderColor: 'rgba(255, 255, 255, 0.1)' }}>
              ...
              <p className="text-sm" style={{ color: 'rgba(255, 255, 255, 0.6)' }}>Candidate Portal</p>
            </div>

            {/* User Info */}
            <div className="px-6 py-4 border-b" style={{ borderColor: 'rgba(255, 255, 255, 0.1)' }}>
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: 'rgba(59, 140, 153, 0.2)' }}>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs truncate" style={{ color: 'rgba(255, 255, 255, 0.6)' }}>Candidate</p>
                </div>
              </div>
            </div>

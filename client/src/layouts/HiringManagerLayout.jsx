  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--surface)' }}>
      ...
      <div className="lg:hidden border-b px-4 py-3 flex items-center justify-between" style={{ backgroundColor: 'var(--surface-alt)', borderColor: 'var(--border)' }}>
        <h1 className="text-xl font-bold" style={{ color: 'var(--accent)' }}>TalentSync</h1>
        <button
        ...
        `} style={{ backgroundColor: 'var(--sidebar)', borderColor: 'var(--border)' }}>
          <div className="flex flex-col h-full">
            ...
            <div className="hidden lg:block px-6 py-4 border-b" style={{ borderColor: 'rgba(255, 255, 255, 0.1)' }}>
              ...
              <p className="text-sm" style={{ color: 'rgba(255, 255, 255, 0.6)' }}>Hiring Manager</p>
            </div>

            {/* User Info */}
            <div className="px-6 py-4 border-b" style={{ borderColor: 'rgba(255, 255, 255, 0.1)' }}>
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: 'rgba(227, 168, 87, 0.2)' }}>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs truncate" style={{ color: 'rgba(255, 255, 255, 0.6)' }}>Hiring Manager</p>
                </div>
              </div>
            </div>
